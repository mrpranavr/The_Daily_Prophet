...
const SearchBox = () => {
    ...
    return (
        <form onSubmit={handleSearch} className="mt-[10px] xs:max-w-[465px] sm:px-0 px-6 mx-auto flex justify-center items-center">
            <div className="relative w-full">
                ...
                >
                    <svg
                        ...
                        className={`fill-accentRed dark:fill-lightWhite ${!input && 'fill-[#e4b0a6] dark:fill-[#9ba8b1]'}`}
                    >
                        <path
